...
The long form, moved out of the README when it went lean: how the WebGL run
(v2, at `/v2`) was built and why — the ovum, the materials, the flight, the
icosahedron, the computation, the room and the loop home — and the reasoning
that carried into v3. The README is the overview; `CLAUDE.md` has v3's own
notes and the working agreements.
